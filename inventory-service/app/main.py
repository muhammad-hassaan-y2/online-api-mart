...
from app.crud.inventory_crud import add_new_product, get_all_products, get_product_by_id, delete_product_by_id, update_product_by_id
...
@app.post("/manage-products/new-product", response_model=Product)
